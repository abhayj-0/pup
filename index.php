...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div>
              <a class="nav-link btn btn-primary" style="color:#fff;" href="levelsPortal.php">LOGIN</a>
          </div>
    </nav>
    <div class="container">
  ...
  <form action="signupdatabase.php" method="post" enctype="multipart/form-data">
    <div class="Registration-Information">
     ...
     <input type="submit" class="btn btn-primary btn-lg btn-block defaultCheck2"  id="btnaling" name="ss1" value="Submit">
    
    <!--<button type="button" class="btn btn-primary btn-lg btn-block defaultCheck2" >Submit</button>-->
    </form>
    <form action="signupdatabase.php" method="post" enctype="multipart/form-data">
       ...
       <div class="form-row">
        ...
        <div class="form-row">
                 <div class="col-6 col-padding">
                    ...
                    <input type="text" class="form-control defaultCheck3" value="Phd" readonly name="type_of_degree" >
                 </div>
                 <div class="col-6">
                   <label for="Date Picker">Date of Birth</label>
    ...
    <!--<button type="button" class="btn btn-primary btn-lg btn-block defaultCheck3" >Submit</button>-->
    </form>
    <form action="signupdatabase.php" method="post" enctype="multipart/form-data">
    ...
    <div class="clearfix"></div>
     <div class="form-group row">
            <div class="col-sm-12 text-center">
              <input type="submit" class="btn btn-primary btn-lg btn-block defaultCheck4" id="btnaling" name="ss3" value="Submit" disabled>
            </div>
      </div>
    </form>
    ...
    <?php //echo link_tag('assets/css/mian.js');?>
  </body>
</html>