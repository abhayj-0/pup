...
<html lang="en">
  ...
  <body>
    ...
    <div class="search-form">
      ...
      <form target="_blank" action="result.html">
           <div class="form-row">
                <div class="col-sm-4">
                  <input type="search" name="reg_no" class="form-control" placeholder="Registration Number">
                </div>
                <div class="col-sm-2 text-center">
              <input type="submit" class="btn btn-primary" id="btnaling" name="ss" value="Submit">
            </div>
