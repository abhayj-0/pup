...
if(isset($_POST['LZd'])){
	...
	$filename = "photos/" . $idf. "/" ;//. "/"
		...
		//if (!is_dir($filename)) { 
			...
			header("location:login-landing_others.php?id=10000");
			//echo "done";
		//}
		/*else{
...
if(isset($_POST['LZerod'])){
	...
	$cmd2 = $db->prepare("INSERT INTO main(file1,file2,file3,file4,file5,file6,level,temp,comment,dlevel0,
		type_of_examination,datef,regno,zerid) VALUES(:fil1,:fil2,:fil3,:fil4,:fil5,:fil6,:leve,:tem,:comm,:f1s,:toe,:df,:reg,:zid)" );
	$cmd2->execute([
		':reg'=>$regno,
		':fil1'=>$file1,
		':fil2'=>$file2,
	...
	echo $nal2;//char nal nahin aa rahe
