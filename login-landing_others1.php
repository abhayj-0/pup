      ...
      <div class="row">
          <div class="col-3 side-bar">
              <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                ...
                <a class="nav-link side-link" id="v-pills-print-tab" data-toggle="pill" href="#v-pills-syno" role="tab" aria-controls="v-pills-print" aria-selected="false">Syopsis</a>
                <?php }?>
                     ...
                     <thead>
                      ...
                      <tbody>
                        <?php if($_SESSION['levell']=='Level3'){
                          ...
                          $qry16new = $db->prepare("select regno,file1,file2,file3,file4,file5,file6,comment,datef,type_of_examination  from main where temp=:tro AND level=:o AND type_of_examination=:yot" );
                        $qry16new->execute([
                          ':tro'=>'Yes',
                          ':o'=>'Level1',
                          ':yot'=>'synopsis'
                          ]);
                        while($ruu16new = $qry16new->fetch(PDO::FETCH_OBJ))
                        {
                            $rnew=$ruu16new->regno;
...
/*ethon no2 udaya*/
                      ...
                      if($_SESSION['levell']=='Level2'){
                       ...
                       //echo $_SESSION['uid'];//chal raha hai
                          ...
                          $qry1867 = $db->prepare("select level from main where regno=:tro121" );
                          $qry1867->execute([
                            ':tro121'=>$rp
                            ]);
